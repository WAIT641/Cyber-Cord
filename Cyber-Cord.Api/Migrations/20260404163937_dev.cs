    ...
    public partial class dev : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.DropForeignKey(
                name: "FK_BanUserServers_Servers_ServerId",
                table: "BanUserServers");

            migrationBuilder.DropForeignKey(
                name: "FK_BanUserServers_Users_UserId",
                table: "BanUserServers");

            migrationBuilder.DropForeignKey(
                name: "FK_Friendships_Users_ReceivingId",
                table: "Friendships");

            migrationBuilder.DropForeignKey(
                name: "FK_Friendships_Users_RequestingId",
                table: "Friendships");

            migrationBuilder.DropForeignKey(
                name: "FK_Channel_Servers_ServerId",
                table: "Channel");
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MessageTemplate = table.Column<string>(type: "nvarchar(2048)", maxLength: 2048, nullable: false),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "019d4030-c571-7443-8603-22e7c935c890", "Admin", "ADMIN" },
                    { 2, "019d4031-0d0c-7d0f-85de-f62e6b9eaed8", "User", "USER" }
                });
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_BanUserServers_AspNetUsers_UserId",
                table: "BanUserServers",
                column: "UserId",
                principalTable: "AspNetUsers",
                principalColumn: "Id",
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_Friendships_AspNetUsers_ReceivingId",
                table: "Friendships",
                column: "ReceivingId",
                principalTable: "AspNetUsers",
                principalColumn: "Id",
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_Friendships_AspNetUsers_RequestingId",
                table: "Friendships",
                column: "RequestingId",
                principalTable: "AspNetUsers",
                principalColumn: "Id",
